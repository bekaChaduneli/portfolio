  ...
  return (
    <div
      className={classNames(
        "absolute flex flex-col duration-300 w-full h-full overflow-hidden lg:hidden bg-[#ede7de] dark:bg-[#283d8b] top-0 z-[30] animate-link-opacity",
        {
      ...
      <div className="flex flex-col items-center mt-[20vh]">
        ...
        >
          <TransitionLink
            href={`/${locale}`}
            className={classNames(
              "text-[#283d8b] dark:text-[#ede7de] text-[38px] sm:text-[46px] md:text-[52px] font-bold uppercase",
              {
          ...
          <TransitionLink
            href={`/${locale}/main`}
            className={classNames(
              "text-[#283d8b] dark:text-[#ede7de] text-[38px] leading-[100%] sm:text-[46px] md:text-[52px] font-bold uppercase",
              {
                "opacity-[75%]":
