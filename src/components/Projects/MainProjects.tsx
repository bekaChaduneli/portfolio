...
export default function MainProjects({
  ...
  return (
    <div className="flex flex-wrap gap-[50px] md:gap-0 justify-between w-full lg:w-[70%] xl:w-[71%]">
          ...
          >
            ...
            >
              <div
                ...
                className="mb-[20px] md:mb-[24px] lg:mb-[20px] xl:mb-[24px] h-[268px] lg:w-[266px] lg:h-[266px] xl:w-[330px] xl:h-[330px] overflow-hidden bg-cover transition-all rounded-[16px] md:rounded-none md:hover:rounded-[60%] duration-700"
              >
                <Image
